...
public final class WallpaperActivity extends AppCompatActivity {
    ...
    private static final String ATLAS = WEBSITE + "#evolution-tree";
    private static final String ANCESTRY = WEBSITE + "ancestry";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        openWebsiteButton.setOnClickListener(view -> openInsideApp(ANCESTRY));
        openAtlasButton.setOnClickListener(view -> openInsideApp(ATLAS));
    ...
    private void openInsideApp(String url) {
    ...
    private void restoreThemeSelection(MaterialButtonToggleGroup themeGroup) {
        ...
        int checkedId = WallpaperPreferences.THEME_AURORA.equals(theme)
            ? R.id.themeAurora
            : WallpaperPreferences.THEME_DAWN.equals(theme) ? R.id.themeDawn : R.id.themeAbyss;
    ...
    private void stylePreview(String theme) {
        int dateColour = WallpaperPreferences.THEME_DAWN.equals(theme)
            ? Color.parseColor("#FFB648")
            : WallpaperPreferences.THEME_AURORA.equals(theme) ? Color.parseColor("#78BFFF") : Color.parseColor("#4FF0C4");
